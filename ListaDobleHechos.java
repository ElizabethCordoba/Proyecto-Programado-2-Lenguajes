...
//Definición de la Clase Lista
 public class ListaDobleHechos
{
  public NodosListaDobleHechos  PrimerNodo;
  public NodosListaDobleHechos  UltimoNodo;
...
// Imprime el contenido de la lista
 ...
 { if (VaciaLista())
  ...
  else
  {
      ...
      NodosListaDobleHechos Actual = PrimerNodo;

     while (Actual != null)
	 {
      System.out.print (Actual.Functor + "-"+Actual.Aridad+"-"+Actual.Argumentos +"-->");
...
public void InsertaInicio (String functor,int aridad,String argumentos)
{ if (VaciaLista())
   PrimerNodo = new NodosListaDobleHechos  (functor,aridad,argumentos);
  else{
   PrimerNodo = new NodosListaDobleHechos  (functor,aridad,argumentos, PrimerNodo);
...
public void InsertaFinal(String functor,int aridad,String argumentos)
{ if ( VaciaLista())
     PrimerNodo = new NodosListaDobleHechos (functor,aridad,argumentos);
  else
     {
      NodosListaDobleHechos  aux= PrimerNodo;
     ...
     */
     //Segunda Forma
      NodosListaDobleHechos  Nuevo = new NodosListaDobleHechos (functor,aridad,argumentos);
      aux.siguiente= Nuevo;
      Nuevo.anterior= aux;
